    ...
    function HelpCard(){
        return (
            <View className="my-5 items-center justify-center border-2 border-blue-300 rounded-md bg-gray-200 px-2 py-4">
                ...
                <ButtonWithConfirmation className="mb-3 px-2 py-2 bg-gray-100 border self-center rounded-md border-blue-300 border-2 hover:bg-blue-200 bg-gray-200"
                ...
                <ButtonWithConfirmation className="mb-3 px-2 py-2 bg-gray-100 border self-center rounded-md border-blue-300 border-2 hover:bg-blue-200 bg-gray-200"
                  ...
                  <Text className="text-blue-500 text-6 text-center font-primary text-5 m-auto">Return {momName} to the help list</Text>
                </ButtonWithConfirmation>
            </View>
        );
    }
